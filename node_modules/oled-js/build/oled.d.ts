...
declare type Direction = 'left' | 'left diagonal' | 'right' | 'right diagonal';
declare type Black = 0x00;
declare type White = 0x01 | 0xff;
declare type Color = Black | White;
declare type Pixel = [number, number, Color];
...
declare const _default: {
    new (board: Board, five: any, opts: OledOptions): {
        ...
        writeString(font: Font, size: number, string: string, color: Color, wrap: boolean, linespacing: number, sync?: boolean): void;
